...
OPENINGS: list[str] = [
    ...
    # --- appended 2026-08-19: the curated scripts/head_to_head.py book, converted
    # from its UCI move-sequence form to FENs. Strictly APPENDED, and --openings
    # slices from the front, so every earlier result at --openings 24 is unchanged.
    # Needed because two near-equal deterministic engines draw 50-65% of games, so
    # 48 games cannot resolve a ~20 Elo gap.
